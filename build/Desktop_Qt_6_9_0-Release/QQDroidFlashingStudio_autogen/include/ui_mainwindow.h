...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(502, 322);
        QSizePolicy sizePolicy(QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(MainWindow->sizePolicy().hasHeightForWidth());
        MainWindow->setSizePolicy(sizePolicy);
        QIcon icon(QIcon::fromTheme(QString::fromUtf8("media-flash")));
        ...
        actionget_unlock_ability->setIcon(icon4);
        ...
        actionunlock_critical->setIcon(icon5);
        ...
        actionlock_critical->setIcon(icon6);
        ...
        menuPick->addAction(actionPartition_Name);
        menuPick->addAction(actionImage_File);
        menuPick->addSeparator();
        menuPick->addAction(actionClear_values);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionImage_File->setText(QCoreApplication::translate("MainWindow", "Image File...", nullptr));
        actionPartition_Name->setText(QCoreApplication::translate("MainWindow", "Partition Name...", nullptr));
        actionClear_values->setText(QCoreApplication::translate("MainWindow", "Clear values", nullptr));
        menuFile->setTitle(QCoreApplication::translate("MainWindow", "Main menu", nullptr));
        ...
        menuPick->setTitle(QCoreApplication::translate("MainWindow", "Pick...", nullptr));
    } // retranslateUi
